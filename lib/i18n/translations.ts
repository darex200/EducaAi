...
export const translations = {
  en: {
    ...
    selectTopicFirst: "Select a topic from the menu (☰) before using this tool.",
    documentMimeMismatch: "The file content does not match its extension.",
    progress: "Progress",
    ...
    authContinueWithoutSignIn: "Continue without signing in",
    authLoginTitle: "Welcome back",
    authRegisterTitle: "Create your account",
    authLoginSubtitle: "Sign in with your email and password.",
    authRegisterSubtitle: "Register to save your history and progress.",
    authDemoTitle: "Enter Educa AI",
    authDemoSubtitle: "Just enter your name. No email or password needed.",
    authNamePlaceholder: "Your name",
    authEmailPlaceholder: "Email address",
    authPasswordPlaceholder: "Password (minimum 6 characters)",
    authSubmitLogin: "Sign in",
    authSubmitRegister: "Register",
    authSubmittingLogin: "Signing in…",
    authSubmittingRegister: "Creating account…",
    authDemoStart: "Get started",
    authDemoSubmitting: "Entering…",
    authFirstTime: "First time?",
    authCreateAccountLink: "Create account",
  ...
  es: {
    ...
    selectTopicFirst: "Selecciona un tema en el menú (☰) antes de usar esta herramienta.",
    documentMimeMismatch: "El contenido del archivo no coincide con su extensión.",
    progress: "Progreso",
    ...
    authContinueWithoutSignIn: "Continuar sin iniciar sesión",
    authLoginTitle: "Bienvenido de nuevo",
    authRegisterTitle: "Crea tu cuenta",
    authLoginSubtitle: "Inicia sesión con tu correo y contraseña.",
    authRegisterSubtitle: "Regístrate para guardar tu historial y progreso.",
    authDemoTitle: "Entra a Educa AI",
    authDemoSubtitle: "Solo escribe tu nombre. No necesitas correo ni contraseña.",
    authNamePlaceholder: "Tu nombre",
    authEmailPlaceholder: "Correo electrónico",
    authPasswordPlaceholder: "Contraseña (mínimo 6 caracteres)",
    authSubmitLogin: "Iniciar sesión",
    authSubmitRegister: "Registrarse",
    authSubmittingLogin: "Iniciando sesión…",
    authSubmittingRegister: "Creando cuenta…",
    authDemoStart: "Empezar",
    authDemoSubmitting: "Entrando…",
    authFirstTime: "¿Primera vez?",
    authCreateAccountLink: "Crear cuenta",
    authHasAccount: "¿Ya tienes cuenta?",
    authSignInLink: "Inicia sesión",
    authGenericError: "Ocurrió un error. Intenta de nuevo.",
  ...
  pt: {
    ...
    selectTopicFirst: "Selecione um tópico no menu (☰) antes de usar esta ferramenta.",
    documentMimeMismatch: "O conteúdo do arquivo não corresponde à extensão.",
    progress: "Progresso",
    ...
    authContinueWithoutSignIn: "Continuar sem iniciar sessão",
    authLoginTitle: "Bem-vindo de volta",
    authRegisterTitle: "Crie sua conta",
    authLoginSubtitle: "Entre com seu e-mail e senha.",
    authRegisterSubtitle: "Registre-se para salvar seu histórico e progresso.",
    authDemoTitle: "Entrar no Educa AI",
    authDemoSubtitle: "Digite seu nome. Não precisa de e-mail nem senha.",
    authNamePlaceholder: "Seu nome",
    authEmailPlaceholder: "E-mail",
    authPasswordPlaceholder: "Senha (mínimo 6 caracteres)",
    authSubmitLogin: "Entrar",
    authSubmitRegister: "Registrar",
    authSubmittingLogin: "Entrando…",
    authSubmittingRegister: "Criando conta…",
    authDemoStart: "Começar",
    authDemoSubmitting: "Entrando…",
    authFirstTime: "Primeira vez?",
    authCreateAccountLink: "Criar conta",

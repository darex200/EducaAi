...
export function buildTutorSystemPrompt(context?: TutorStudentContext) {
  ...
  return [
    ...
    "- Responde en 3 a 7 lineas como base, salvo que pidan resumen extenso o un numero de palabras concreto.",
    "- Si piden resumen, ensayo o texto largo (ej. 1000 palabras), entrega la extension solicitada con secciones claras.",
